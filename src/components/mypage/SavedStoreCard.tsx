  ...
  return (
    <article className="overflow-hidden rounded-lg border border-[#eef1f5] bg-white">
      ...
      <div className="mx-5 mt-3">
        <div className="flex items-center justify-between gap-2 rounded-md bg-blue-300 px-4 py-3 text-sm font-bold text-blue-600">
          <span className="flex min-w-0 items-center gap-1.5">
            <button
              type="button"
              onClick={() => setIsScoreExpanded((prev) => !prev)}
              aria-expanded={isScoreExpanded}
              className="flex items-center gap-1.5 text-left leading-tight transition hover:brightness-95"
            >
            ...
            <button
              ...
              className="flex shrink-0 items-center transition hover:opacity-70"
            >
          ...
          <button
            ...
            onClick={() => setIsScoreExpanded((prev) => !prev)}
            aria-expanded={isScoreExpanded}
            className="shrink-0 whitespace-nowrap text-xs font-bold transition hover:brightness-95"
          >
