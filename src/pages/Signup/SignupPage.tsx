...
const SignupPage = () => {
  ...
  const [signupMethod, setSignupMethod] = useState<'loginId' | 'social'>(
    'loginId'
  );
            ...
            <>
              ...
              <>
                <div className="mt-8 grid grid-cols-2 text-center text-sm font-medium text-[#191f28]">
                  <button
                    type="button"
                    onClick={() => setSignupMethod('loginId')}
                    aria-current={
                      signupMethod === 'loginId' ? 'page' : undefined
                    }
                    className={
                      signupMethod === 'loginId'
                        ? 'border-b-2 border-blue-600 pb-3'
                        : 'border-b border-[#e5e8eb] pb-3 text-[#8b95a1]'
                    }
                  >
                    아이디로 가입
                  </button>
                  <button
                    ...
                    aria-current={
                      signupMethod === 'social' ? 'page' : undefined
                    }
                    className={
                      signupMethod === 'social'
                        ? 'border-b-2 border-blue-600 pb-3'
                    ...
                    <label className="block">
                      ...
                      <input
                        ...
                        onChange={(event) => {
                          ...
                          if (loginIdError) {
                            setLoginIdError(
                              validateLoginId(event.target.value)
                            );
                          }
                        }}
